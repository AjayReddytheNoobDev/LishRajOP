...
async def unban(c: Client, m: Message):
    ...
    try:
        user_id = int(m.command[1])
        unban_log_text = f"**Unbanned user !** Unban Dena hai toh Ban karte kyu. hunhhh kids \n\n**user id:**{user_id}"
        try:
